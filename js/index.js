$(function(){
    ...
    var musicImgsData = ['img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg','img/bg.jpg']    // 图片地址数组
    var musicNameData = ['I Really Want to Stay......',"Who's Ready For......",'Let You Down','Never Fade Away','EZ4ENCE','Unwelcomed School','Levitating','Celestial','Rage Your Dream','好きなので','mede:mede'];                   // 歌曲名数组
    var artistNameData = ['Cyberpunk','Cyberpunk','Cyberpunk','Cyberpunk','The Verkkars','Blue Archive','Dua Lipa','Ed Sheeran','m.o.v.e','雨宮天','Reol']            // 创作歌手数组
    var musicUrls=['mp3/1.mp3','mp3/2.mp3','mp3/3.mp3','mp3/4.mp3','mp3/5.mp3','mp3/6.mp3','mp3/7.mp3','mp3/8.mp3','mp3/9.mp3','mp3/10.mp3','mp3/11.mp3'];// 歌曲mp3数组
